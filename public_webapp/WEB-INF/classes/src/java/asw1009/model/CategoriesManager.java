...
/**
 * Classe singleton rappresentante il gestore delle categorie.
 * Contiene la lista delle entità Category ed espone ai controllers i metodi per la loro gestione 
 *
 * @author ASW1009
 */
public class CategoriesManager extends FileManager {
    ...
    */
     ...
     * istanzia la lista leggendo dal file, altrimenti crea una lista di categorie nuova. 
     * 
    ...
    * @return instance statico del gestore della categoria inizilizzato all'inizio a null.
    */
    ...
    /**
     * Metodo invocato per recuperare un view model contenente la lista delle categorie
